...
def yaml_model_load(path):
    ...
    yaml_file = check_yaml(unified_path, hard=False) or check_yaml(path) # i.e.  yolov8.yaml -> ultralytics-main/ultralytics/cfg/models/v8/yolov8.yaml
